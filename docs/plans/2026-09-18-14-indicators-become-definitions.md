...
| Checked                                  | Found                                                                                                                                                                                                                                        |
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| What an indicator costs today            | **3,166** lines under `kitchen/src/indicators/`, excluding tests: 2,602 in the eight indicator modules (153 `tax.ts` to 696 `derived.ts`, which carries three), plus 397 of registry and 167 of CPI fetch. Ten indicators took a whole plan. |
