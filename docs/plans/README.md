...
5; the second slice has since taken it to 1,095 and 216, and a count written into prose goes
...
| 11  | [The place beside the map](2026-09-16-11-the-place-beside-the-map.md) | What 0009 could only be seen to need once it was built. The profile moves beside the map, the compare search becomes part of its header, the table takes the map's box and scrolls inside it, both disclosures get a marker, and a shape under the pointer says its own name. Hover is the third thing kept out of the URL on purpose. | **done** |
...
| 14  | [Indicators become definitions](2026-09-18-14-indicators-become-definitions.md) | Four builders and two modifiers, one added; the existing ten migrated onto them; similarity pinned to the core ten. Proves itself by leaving the pantry byte-identical. | **written** |
