...
- Whether Nykvarn (created 1999, split from Södertälje) follows the same pattern confirmed for Knivsta above — not empirically tested by the 2026-09-13 spike, which queried only Knivsta/Uppsala.
