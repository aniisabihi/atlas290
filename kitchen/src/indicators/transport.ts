...
export const CARS: Indicator = Indicator.parse({
  ...
  sensitivity: 'none',
  sources: [{ table: CARS_TABLE, contentCode: 'TK1001AB', note: '2002–2025, Agarkategori 060' }],
  derivation:
    'One SCB cell per municipality and year: TAB3276 at the owner category labelled "totalt ' +
    'antal bilar per 1 000 invånare", which is a rate SCB computes rather than a count. Nothing ' +
    'is divided here. `regions: known` drops the table’s 291st four-digit code, `1917 Heby` — ' +
    'the code Heby carried before it moved from Västmanland to Uppsala county in 2007, where it ' +
    'is 0331.',
})
