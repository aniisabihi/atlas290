...
name: react-testing
description: >-
  React component testing with React Testing Library, Vitest/Jest, MSW for network mocking,
  accessibility assertions with axe, and the decision boundary between component tests and
  Playwright/Cypress end-to-end runs. Use when writing or fixing tests for React components,
  hooks, or pages. Do not use when a more specific skill or command applies.
metadata:
  origin: ECC
---
