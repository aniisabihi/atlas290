...
name: react-patterns
description: >-
  React 18/19 patterns including hooks discipline, server/client component boundaries,
  Suspense + error boundaries, form actions, data fetching, state management decision trees,
  and accessibility-first composition. Use when writing or reviewing React components. Use
  haus.ecc-frontend-patterns for framework-agnostic frontend concerns.
metadata:
  origin: ECC
---
