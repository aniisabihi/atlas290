...
description: >-
  ...
  test-driven development with 80%+ coverage including unit, integration, and E2E tests. Not
  the house TDD bar — that lives in the workflow standard and the superpowers
  test-driven-development plugin. This is the ECC companion that haus.ecc-tdd-guide,
  haus.ecc-react-testing, and haus.ecc-laravel-tdd dispatch to; do not load it as a second
  general TDD procedure.
