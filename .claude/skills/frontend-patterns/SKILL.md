...
description: >-
  ...
  optimization, and UI best practices. Use when building or reviewing React or Next.js
  components, state, or render performance. Do not use when a more specific skill or command
  applies.
metadata:
  origin: ECC
---
